...
urlpatterns = patterns('',
    ...
    url(r'^course/(?P<pk>\d+)/notes/new/$','course.views.newnote'),
    url(r'^course/(?P<pk>\d+)/note/(?P<n>\d+)/$','course.views.noteinfo'),
    url(r'^course/(?P<pk>\d+)/note/(?P<n>\d+)/submit/$','course.views.notesubmit'),
